...
expName = 'Retrieval B'  # from the Builder filename that created this script
expInfo = {
    'Participant ID': '',
    'Task': '',
}
...
filename = _thisDir + os.sep + u'Retrieval B/%s_%s_%s' % (expInfo['Participant ID'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='/Users/mc151/Library/CloudStorage/Box-Box/Leal Lab/Studies/In-Person Study Folders/123_ABBA study/Behavioral Task/A+B/Retrieval_B.py',
...
image_3 = visual.ImageStim(
    win=win,
    name='image_3', 
    image='RetrievalB_Ex1.jpeg', mask=None, anchor='center',
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='END OF THE TEST \n\nPlease ring the doorbell to notify your experimenter that you have finished.\n\nTHANK YOU',
    font='Arial',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('Example_RetrievalB.xlsx', selection='0:4'),
...
trials_1 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Retrieval_B.xlsx', selection='0:91'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Retrieval_B.xlsx', selection='91:182'),
...
_key_resp_2_allKeys = []
# keep track of which components have finished
EndComponents = [text_4, key_resp_2]
